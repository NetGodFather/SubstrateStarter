...
>, ServiceError> {
	...
	// 为 pallet_dotprice 配置一个账号用于签名
	keystore.write().insert_ephemeral_from_seed_by_type::<runtime::pallet_dotprices::crypto::Pair>(
		"//Alice", runtime::pallet_dotprices::KEY_TYPE
